...
void setup() {
  ...
  delay(2000);
  esc.attach(13); // Attach ESC signal wire to pin 13

  // Step 1: Send maximum throttle
  esc.writeMicroseconds(2000);
  delay(2000); // Wait 2 seconds

  // Step 2: Power up ESC now (connect battery). ESC should beep for max throttle.
  // Step 3: After 2 seconds, send minimum throttle
  esc.writeMicroseconds(1000);
